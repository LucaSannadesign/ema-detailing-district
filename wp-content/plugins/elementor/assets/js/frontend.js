...
AssetsLoader.assets = {
  script: {
    ...
    'share-link': {
      src: `${assetsUrl}lib/share-link/share-link${fileSuffix}.js`
    },
  ...
  style: {
    ...
    'e-lightbox': {
      src: elementorFrontendConfig?.responsive?.hasCustomBreakpoints ? `${elementorFrontendConfig.urls.uploadUrl}/elementor/css/custom-lightbox.min.css` : `${assetsUrl}css/conditionals/lightbox${fileSuffix}.css`
    },
    dialog: {
      src: `${assetsUrl}css/conditionals/dialog${fileSuffix}.css`,
      parent: 'head',
